...
enum ActionsShader implements Actions {
    ...
    PALETTE("Palette", "Shader:Palette", (master, name) -> new RFFSettingsWindow(name, panel -> {
    ...
    STRIPE("Stripe", "Shader:Stripe", (master, name) -> new RFFSettingsWindow(name, panel -> {
    ...
    SLOPE("Slope","Shader:Slope", (master, name) -> new RFFSettingsWindow(name, panel -> {
    ...
    FOG("Fog", "Shader:Fog", (master, name) -> new RFFSettingsWindow(name, panel -> {
    ...
    BLOOM("Bloom", "Shader:Bloom", (master, name) -> new RFFSettingsWindow(name, panel -> {
