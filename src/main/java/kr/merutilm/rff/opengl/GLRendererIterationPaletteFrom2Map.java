...
public class GLRendererIterationPaletteFrom2Map extends GLRenderer implements GLIterationTextureProvider{
    ...
    public GLRendererIterationPaletteFrom2Map() {
        super(new GLShaderLoader(GLRenderer.DEFAULT_VERTEX_PATH, "iteration_palette_from_2_map"));
    }
