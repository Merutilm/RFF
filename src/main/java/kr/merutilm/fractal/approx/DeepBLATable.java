...
public class DeepBLATable implements R3ATable{
    ...
    public DeepBLATable(RenderState state, int currentID, R3ASettings blaSettings, DoubleExponent[] zr, DoubleExponent[] zi, int period, DoubleExponent dcMax) throws IllegalRenderStateException {
        this.table = null;
        this.indices = null;
        this.iterationInterval = 0;
        this.period = 0;
        ...
        // for (int i = 1; i < RRRATable.getMaxSkippableIteration(period, iterationInterval); i += iterationInterval) {
        ...
        // table = table.stream().sorted(Comparator.comparing(R3A::targetIter)).toList();
